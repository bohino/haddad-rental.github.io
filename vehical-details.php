...
<title>Location de voiture | Les détails du véhicule</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p><?php echo htmlentities($result->PricePerDay);?> DA</p> par jour
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="fromdate" placeholder="Partir de la date" required>
            </div>
            <div class="form-group">
              <label>À ce jour:</label>
              <input type="date" class="form-control" name="todate" placeholder="À ce jour" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">CONNECTEZ-VOUS POUR RESERVER</a>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price"><?php echo htmlentities($result->PricePerDay);?>DA</p>
